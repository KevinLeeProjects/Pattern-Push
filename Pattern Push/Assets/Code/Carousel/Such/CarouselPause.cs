...
public class CarouselPause : MonoBehaviour
{
    public static CarouselPause testpause1;
    ...
    public static string carouseltapname;
    ...
    public void Unpause()
    {
        ...
        Destroy(GameObject.Find(carouseltapname));
    }
}
